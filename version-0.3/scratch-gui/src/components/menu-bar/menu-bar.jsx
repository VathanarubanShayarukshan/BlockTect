...
import BlockTectProjectDownloader from '../../containers/blocktect-project-downloader.jsx';
                            ...
                            >
                                ...
                                >
                                    ...
                                    <MenuSection>
                                        ...
                                        <BlockTectProjectDownloader>{(className, downloadProjectCallback) => (
                                            <MenuItem
                                                className={className}
                                                onClick={this.getSaveToComputerHandler(downloadProjectCallback)}
                                            >
                                                <FormattedMessage
                                                    defaultMessage="Download Python + HTML project"
                                                    description="Menu item for exporting a Scratch project as a BlockTect web project"
                                                    id="gui.menuBar.downloadBlockTectProject"
                                                />
                                            </MenuItem>
                                        )}</BlockTectProjectDownloader>
                                    </MenuSection>
                                </MenuBarMenu>
                            </div>
                        )}
